...
@section('container')
    ...
    <h3 class="text-center">Servis Yang Sudah Selesai</h3>
    <div class="card">
    <table class="table">
        <thead>
        ...
        <tbody>
            ...
            <tr class="text-center">
              ...
              <td>
                <a href="/laporan/{{ $detail->id }}/cetak" type="button" class="btn btn-outline-secondary">Download PDF</a>
