...
@section('container')
    <div class="container mt-5">
        <h3 class="text-center">Servis Yang Sedang Dikerjakan</h3>
        <div class="card">
        <table class="table">
            <thead>
            ...
            <tbody>
                ...
                <tr class="text-center">
                  ...
                  <td class="d-flex justify-content-center">
                    <a href="/servis-dashboard/{{ $detail->id }}/sparepart" type="button" class="btn btn-outline-secondary">Sparepart</a>
